@echo off
REM Shortcut: auto-locate VS environment and build Windows x86
REM You can also run build-windows.bat directly from "x86 Native Tools Command Prompt"
...
echo [ERROR] Visual Studio not found. Install VS 2017+ or run build-windows.bat from "x86 Native Tools Command Prompt".
exit /b 1
