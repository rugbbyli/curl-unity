@echo off
REM 快捷脚本: 自动定位 VS 环境并编译 Windows x64
REM 也可以直接从 "x64 Native Tools Command Prompt" 运行 build-windows.bat
...
echo [ERROR] 未找到 Visual Studio。请安装 VS 2019+ 或从 "x64 Native Tools Command Prompt" 手动运行 build-windows.bat
exit /b 1
